...
int main() {
    ...
    while (running) {
        ...
        al_draw_text(font, al_map_rgb(255, 255, 255), SCREEN_WIDTH / 2, SCREEN_HEIGHT / 4,
                     ALLEGRO_ALIGN_CENTER, "Digite seu Username:");
        al_draw_rectangle(SCREEN_WIDTH / 4, SCREEN_HEIGHT / 2 - 20, SCREEN_WIDTH * 3 / 4, SCREEN_HEIGHT / 2 + 20,
                          al_map_rgb(255, 255, 255), 2);
        al_draw_text(font, al_map_rgb(255, 255, 255), SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2 - 16,
